...
ノード（の四角）の上で、shiftキーを押しながらダブルクリックして、ノード名・ノード内容を入力します。
...
ノード（の四角）の上で、（shiftキーを押さずに）ダブルクリックして、ノード名・ノード内容を入力します。
...
`24px`、`12pt`,`large`のように文字の大きさを指定します。
...
文字の表示に使いたい色を選択します。色の指定方法はブラウザにより、異なります。「ＯＫ」ボタンがないときは、他の何もない箇所をクリックします。
